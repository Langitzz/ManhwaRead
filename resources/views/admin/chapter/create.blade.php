                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="nomor_chapter" id="nomor_chapter"
                                    ...
                                    value="{{ old('nomor_chapter') }}" placeholder="Contoh: 1" min="1"
                                    autocomplete="off">
                                @error('nomor_chapter')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="judul_chapter" id="judul_chapter"
                                    ...
                                    value="{{ old('judul_chapter') }}" placeholder="Opsional" autocomplete="off">
                                @error('judul_chapter')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <small class="text-muted">
                                    Kosongkan jika ingin pakai halaman pertama sebagai thumbnail otomatis.
                                </small>
                                @error('thumbnail')
