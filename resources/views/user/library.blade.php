...
@section('content')
    ...
    <section class="section py-5">
        <div class="container">
            ...
            @guest
                <div class="text-center py-5">
                    <i class="bi bi-bookmark-heart" style="font-size: 4rem; opacity: 0.4;"></i>
                    <h4 class="mt-3">Kamu belum login</h4>
                    <p class="text-muted">
                        Login dulu buat nyimpen bookmark & lihat riwayat bacaanmu di sini.
                    </p>
